...
importStopword(filename='./meeting_cms.txt')
...
text = open(path.join(d, 'meeting_cms.txt'),encoding ='utf-8').read()
...
wc = WordCloud( font_path='C:\Windows\Fonts\simfang.ttf',#设置字体
